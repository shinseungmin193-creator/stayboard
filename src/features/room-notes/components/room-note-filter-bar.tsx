...
export async function RoomNoteFilterBar({ filters, options }: { filters: RoomNoteFilters; options: RoomNoteOptions }) {
  ...
  return <form method="get" className="grid gap-2 rounded-xl border bg-card p-3 sm:grid-cols-2 lg:grid-cols-[minmax(10rem,0.7fr)_minmax(12rem,0.8fr)_minmax(16rem,1.5fr)_auto_auto] lg:items-end">
