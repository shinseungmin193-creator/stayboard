export type SyncErrorCode = "ICS_DOWNLOAD_FAILED" | "ICS_HTTP_403" | "ICS_HTTP_404" | "ICS_TIMEOUT" | "ICS_INVALID_CONTENT" | "ICS_PARSE_FAILED" | "SOURCE_DISABLED" | "SOURCE_URL_INVALID" | "PROVIDER_CLASSIFICATION_FAILED" | "DATABASE_WRITE_FAILED" | "UNKNOWN_ERROR";

export const SYNC_ERROR_MESSAGES: Record<SyncErrorCode, string> = {
  ICS_DOWNLOAD_FAILED: "OTA 캘린더를 다운로드하지 못했습니다. 잠시 후 다시 시도하세요.", ICS_HTTP_403: "OTA 캘린더에 접근할 수 없습니다. Calendar URL을 다시 확인하세요.", ICS_HTTP_404: "OTA 캘린더를 찾을 수 없습니다. Calendar URL을 다시 확인하세요.", ICS_TIMEOUT: "OTA 응답 시간이 초과되었습니다. 잠시 후 다시 시도하세요.", ICS_INVALID_CONTENT: "OTA 응답이 유효한 캘린더 형식이 아닙니다.", ICS_PARSE_FAILED: "캘린더 형식을 읽을 수 없습니다.", SOURCE_DISABLED: "비활성화된 CalendarSource입니다.", SOURCE_URL_INVALID: "Calendar URL이 올바르지 않습니다.", PROVIDER_CLASSIFICATION_FAILED: "OTA 이벤트를 예약으로 분류하지 못했습니다.", DATABASE_WRITE_FAILED: "동기화 결과를 저장하지 못했습니다.", UNKNOWN_ERROR: "동기화 중 안전하게 처리할 수 없는 오류가 발생했습니다.",
};
