...
export function getRoomCalendarStatus(input: { activeSourceCount: number; targetCount?: number; successCount?: number; failedCount?: number; running?: boolean; warning?: boolean }): RoomCalendarStatus {
