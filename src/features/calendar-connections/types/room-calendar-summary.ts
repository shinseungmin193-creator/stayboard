...
export interface CalendarSourceSummary {
  ...
  latestBlockedCount: number; latestUnknownCount: number; latestRetryCount: number; latestHttpStatus: number | null; latestErrorCode: string | null; latestErrorMessage: string | null; latestErrorDetails: string | null; latestDurationMs: number | null; isSyncing: boolean;
}
