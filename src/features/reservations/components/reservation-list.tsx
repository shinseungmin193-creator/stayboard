...
export function ReservationList({ reservations, onSelect }: {reservations: ReservationViewModel[];onSelect: (reservation: ReservationViewModel) => void;}) {const locale = useLocale(),localeTag = locale === "ja" ? "ja-JP" : "ko-KR";const dateFormatter = new Intl.DateTimeFormat(localeTag, { timeZone: "Asia/Tokyo", year: "numeric", month: "2-digit", day: "2-digit" });const i18n = useTranslations();
  return (
    <>
