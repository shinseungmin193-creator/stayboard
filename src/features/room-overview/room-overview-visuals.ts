...
export const ROOM_OVERVIEW_STATUS_VISUALS = {
  VACANT: { strong: "#2563eb", medium: "#1d4ed8", soft: "rgb(37 99 235 / 0.68)", rgb: "37 99 235", foreground: "#ffffff" },
  OCCUPIED: { strong: "#f59e0b", medium: "#d97706", soft: "rgb(245 158 11 / 0.68)", rgb: "245 158 11", foreground: "#1c1917" },
  CHECK_IN_TODAY: { strong: "#22c55e", medium: "#16a34a", soft: "rgb(34 197 94 / 0.68)", rgb: "34 197 94", foreground: "#052e16" },
  CHECK_OUT_TODAY: { strong: "#f97316", medium: "#ea580c", soft: "rgb(249 115 22 / 0.7)", rgb: "249 115 22", foreground: "#1c1917" },
  CLEANING_REQUIRED: { strong: "#14b8a6", medium: "#0d9488", soft: "rgb(20 184 166 / 0.68)", rgb: "20 184 166", foreground: "#042f2e" },
  INSPECTION_REQUIRED: { strong: "#8b5cf6", medium: "#7c3aed", soft: "rgb(139 92 246 / 0.7)", rgb: "139 92 246", foreground: "#ffffff" },
  CONFLICT: { strong: "#ef4444", medium: "#dc2626", soft: "rgb(239 68 68 / 0.72)", rgb: "239 68 68", foreground: "#ffffff" },
